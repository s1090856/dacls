...
log=train_model([dh1],epochs=200,test_ratio=0.2,drop_probability=0.0,with_teacher=False,batch_size=256,unseen=None)
log.to_csv('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None.csv')
log.to_latex('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None.latex')
f=log.plot(y='Train_Loss',x='Epoch').get_figure()
f.savefig('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None__Train_Loss.png')
f=log.plot(y='Test_Loss',x='Epoch').get_figure()
f.savefig('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None__Test_Loss.png')
f=log.plot(y='Test_Accuracy',x='Epoch').get_figure()
f.savefig('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None__Test_Accuracy.png')
f=log.plot(y='F1_macro',x='Epoch').get_figure()
f.savefig('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None__F1_macro.png')
f=log.plot(y='ANE',x='Epoch').get_figure()
f.savefig('Set-dh1_Epochs-200_Ratio-0.2_Drop-0.0_Teacher-False_BSize-256_Unseen-None__ANE.png')
